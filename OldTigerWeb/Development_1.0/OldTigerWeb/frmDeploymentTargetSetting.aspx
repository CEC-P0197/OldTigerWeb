<%@Page Language="C#" AutoEventWireup="true" CodeBehind="frmDeploymentTargetSetting.aspx.cs" Inherits="OldTigerWeb.frmDeploymentTargetSetting"%>
<!DOCTYPE html>
...
<body class="SubWindowStyle">
    <form id="FormDeploymentTargetSetting" runat="server">
        <%--タイトル--%>
        ...
        <table>
            <tr>
                <td>
                    <%--過去トラ観たかヘッダー--%>
                    【抽出条件】
                    <div class="DeploymentTargetSettingDiv tableDiv">
            ...
            <tr>
                <td>
                    <div class="DeploymentTargetSettingTroubleListDiv tableDiv">
                        <%--過去トラ観たかリスト--%>
                    ...
                    <input type="button" value="決定" class="buttoncolor btnSmall" onclick="CloseDialog();" />
                </td>
            </tr>
        </table>
