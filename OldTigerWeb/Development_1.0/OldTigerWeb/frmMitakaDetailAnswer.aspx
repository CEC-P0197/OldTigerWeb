<%@Page Language="C#" AutoEventWireup="true" CodeBehind="frmMitakaDetailAnswer.aspx.cs" Inherits="OldTigerWeb.frmMitakaDetailAnswer"%>
<!DOCTYPE html>
...
<body class="SubWindowStyle">
    <form id="FormMitakaDetail" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>
                        <input type="button" value="回答" class="buttoncolor btnSmall" onclick="openDialogMitakaAnswer();" />
...
<script type="text/javascript">
    ...
    function openDialogMitakaAnswer() {
        var timestamp = new Date().getTime();

        // 1. 画面のオープン
        var url = "frmMitakaAnswer.aspx?" + timestamp;
