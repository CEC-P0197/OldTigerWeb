<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDivisionSearch.aspx.cs" Inherits="OldTigerWeb.frmDivisionSearch" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>回答対象部署変更</title>
</head>
<body class="SubWindowStyle">
    <form id="FormfrmDivisionSearch" runat="server">
        <%--タイトル--%>
        ...
        <br/>
        <%--データ部--%>
        <table class="DivisionSearchTable" style="width:100%;">
            <tr>
                <td>
                    <%--検索条件入力テーブル--%>
                    <table class="DivisionSearchCriteriaTable" style="width:50%;">
                        <tr>
                            <td class="SubWindowTableHeader">
                                課・主査
                            </td>
                            <td>
                                <asp:TextBox ID="TxtDivision" placeholder="課・主査" runat="server" />
                            </td>
                            <td class="SubWindowTableHeader">
                                部
                            </td>
                            <td>
                                <asp:TextBox ID="TxtDepartment" placeholder="部" runat="server" />
                            </td>
                            <%--<td colspan="4"></td>--%>
                        </tr>
                        <tr>
        ...
        <table class="DivisionSearchArea" style="width:100%;">
            <tr>
                <td class="tdSearchArea">
                    ≪検索結果≫
                    <%--検索結果テーブル--%>
                    <div class="DivisionSearchResultListDiv tableDiv">
                        <table border="1" id="SearchResultTable" class="tratbl">
                            <thead>
                                <tr>
                                    <th>BY/PU</th>
                                    <th>部署</th>
                ...
                <td class="tdSearchArea">
                    ...
                    <%--選択済テーブル--%>
                    <div class="DivisionSearchResultListDiv tableDiv">
                        <table border="1" id="SelectedTable" class="tratbl">
                            <thead>
                                <tr>
                                    <th>課・主査</th>
                                </tr>
